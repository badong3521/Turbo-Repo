...
export const initialEdges: Edge[] = [
  ...
  { id: "css->responsive", source: "css", target: "responsive", animated: true },
  { id: "css->positioning", source: "css", target: "positioning", animated: true },
  ...
  { id: "javascript->ES6", source: "javascript", target: "ES6", animated: true },
  { id: "javascript->eventLoop", source: "javascript", target: "event-loop", animated: true },
  { id: "javascript->modules", source: "javascript", target: "modules", animated: true },
  { id: "javascript->promise", source: "javascript", target: "promise", animated: true },
  { id: "javascript->fetch", source: "javascript", target: "fetch", animated: true },
  ...
  { id: "react->performanceReact", source: "react", target: "performance-react", animated: true },
  { id: "typescript->react", source: "typescript", target: "react" },
  { id: "react->stateManagement", source: "react", target: "state-management", animated: true },
