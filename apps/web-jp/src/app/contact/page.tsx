...
import { InquiryTypeEnum } from "@/api/type/send-mail";
import { DocumentTypeEnum, ReasonToKnowEnum } from "@/api/type/send-mail";
  ...
  return (
    <div className="di-font-mplus1">
      ...
      <div className="di-mx-8 di-text-center">
        <div className="di-text-main-blue di-text-[64px] xl:di-my-20 di-my-12 di-font-bold">
          基本情報
        </div>
      ...
      <div className="di-flex di-justify-center di-w-full di-flex-wrap sm:di-flex-nowrap di-gap-4 xl:di-px-12 di-px-4 di-mb-14">
        <form className="di-w-full" onSubmit={handleSubmit(onSubmit)}>
          <div className="di-grid di-grid-cols-1 lg:di-grid-cols-2 di-gap-6">
            <div className="di-flex di-flex-col">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <select
                    {...field}
                    value={field.value ?? "CompanyProfile"}
                    className="di-border di-border-gray-300 di-rounded-md di-px-2 di-py-4 di-w-full"
                  >
                    {Object.entries(DocumentTypeEnum).map(([key, value]) => (
              ...
              />
              {errors.documentType ? (
                <p className="di-text-red-500">{errors.documentType.message}</p>
              ) : null}
            </div>

            <div className="di-flex di-flex-col">
              <div className="di-font-bold">電話番号</div>
              <Controller
                name="phone"
                control={control}
                defaultValue=""
            ...
            <div className="di-flex di-flex-col">
              <div className="di-font-bold">フリガナ</div>
              <Controller
                name="rubyCharacter"
                control={control}
                defaultValue=""
            ...
            <div className="di-flex di-flex-col di-row-span-2">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <textarea
                    {...field}
                    className="di-border di-border-gray-300 di-rounded-md di-px-2 di-py-4 di-w-full di-h-full di-min-h-40"
                  />
                )}
              />
          ...
          <div className="di-flex di-justify-center di-m-14">
            <JpButton
